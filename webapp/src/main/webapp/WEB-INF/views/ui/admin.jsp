...
<div class="container">
    ...
    <div class="main">
        ...
        <form class="well" id="create-user" action="ui/admin/user" method="post">
        ...
        <form class="well" id="create-organisation" action="ui/admin/organisation" method="post">
            <div class="form-group">
        ...
        <form class="well" id="create-facility" action="ui/admin/facility" method="post">
            <div class="form-group">
                <label for="name">Name</label>
                <input class="form-control" name="name" type="text" placeholder="Name" autofocus required>
            </div>
        ...
        <form class="well" id="create-system" action="ui/admin/system" method="post">
            <div class="form-group">
