...
public interface RouteOfAdministrationRespository extends PagingAndSortingRepository<RouteOfAdministration, Long> {

    @Query("select routeOfAdministration " +
            "from RouteOfAdministration routeOfAdministration " +
            "join routeOfAdministration.codes.codes code " +
