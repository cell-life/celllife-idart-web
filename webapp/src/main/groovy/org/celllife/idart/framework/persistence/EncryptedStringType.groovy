...
public final class EncryptedStringType implements UserType, ParameterizedType {
    ...
    public final Object nullSafeGet(final ResultSet rs, final String[] names, SessionImplementor sessionImplementor, final Object owner)
    ...
    public final void nullSafeSet(final PreparedStatement st, final Object value, final int index, SessionImplementor sessionImplementor)
    throws HibernateException, SQLException {
        checkInitialization()
        if (value == null) {
