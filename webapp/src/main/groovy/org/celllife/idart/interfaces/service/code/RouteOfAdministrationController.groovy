 ...
 * Time: 20h03
 */
@Controller class RouteOfAdministrationController {

    @Autowired RouteOfAdministrationService routeOfAdministrationService

    @RequestMapping(value = "/service/codes/routes", method = RequestMethod.POST)
    void uploadHl7(@RequestParam("structure") String structure,
