...
@Controller class UserResourceController {
    ...
    @ResponseBody
    @RequestMapping(
            value = "/users/{userIdentifier}",
            method = RequestMethod.GET, produces = "application/json"
    )
    User findByUserIdentifier(@PathVariable("userIdentifier") UserIdentifier userIdentifier) {
        userApplicationService.findByUserIdentifier(userIdentifier)
    }
